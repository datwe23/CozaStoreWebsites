<div class="wrap-header-cart js-panel-cart">
    ...
    <div style="display:flex;justify-content:space-between;padding-left:33px"class="header-cart flex-col-l p-l-65 p-r-25">
      <div  style="width:340px" class="header-cart-title flex-w flex-sb-m p-b-8">
        <span class="mtext-103 cl2">
            CART
        </span>
  
        <div style="padding-left:170px" class="fs-35 lh-10 cl2 p-lr-5 pointer hov-cl1 trans-04 js-hide-cart">
