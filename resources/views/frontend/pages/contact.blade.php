        ...
        <div class="flex-w flex-tr">
            <div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
                <form name="contactForm" ng-submit="submitContactForm()" novalidate>
                    ...
                    <!-- Div Thông báo lỗi 
            Chỉ hiển thị khi các validate trong form `contactForm` Illegal => contactForm.$invalid = true
            Sử dụng tiền chỉ lệnh ng-show="contactForm.$invalid"
            -->
                    <div class="alert alert-danger" ng-show="contactForm.$invalid">
                        <ul>
                            <!-- Thông báo lỗi email -->
                            <li><span class="error" ng-show="contactForm.email.$error.required">Please enter your email</span></li>
                            <li><span class="error" ng-show="!contactForm.email.$error.required && contactForm.email.$error.pattern">Only gmail.com is accepted, please check again</span></li>

                            <!-- Thông báo lỗi message -->
                            <li><span class="error" ng-show="contactForm.message.$error.required">Please enter a message</span></li>
                            <li><span class="error" ng-show="contactForm.message.$error.minlength">Message must be > 6 characters</span></li>
                            <li><span class="error" ng-show="contactForm.message.$error.maxlength">Message must be <= 250 characters</span> </li> </li> </div> <!-- Div Thông báo validate hợp lệ Chỉ hiển thị khi các validate trong form `contactForm` không hợp lệ=> contactForm.$valid = true
                                        Sử dụng tiền chỉ lệnh ng-show="contactForm.$valid"
                                        -->
                                        <div class="alert alert-success" ng-show="contactForm.$valid">
                                            Valid information, please press the . button <b>"Gởi lời nhắn"</b> to send an email to the Webmaster<br />
                                            Thank you very much for your comments, suggestions and questions.
                                        </div>
