        ...
        <div class="col-12">
            <div style="padding:30px" class="card mb-4">
                <div style="padding-left:0px ; padding-top:0px ;border-bottom:1px solid rgb(94, 92, 92) " class="card-header pb-0">
                    <h6 style="padding-bottom: 7px">Customers edit page</h6>
                </div>
                <div >
                      ...
                      <form method="post" action="{{ route('customer.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          <div style="padding-top:10px"class="form-group col-6">
                            <label for="kh_hoTen">Customers ID</label>
                            <input type="text" class="form-control" id="kh_ma" name="kh_ma" >
                          </div>
                        <div style="padding-top:10px"class="form-group col-6">
                          <label for="kh_hoTen">name</label>
                        ...
                        <div class="form-group col-4">
                          ...
                          <input type="text" class="form-control" id="kh_matKhau" name="kh_matKhau" >
                        </div>

                        <div class="form-group col-4">
                          <label for="kh_email">Email</label>
                          <input type="text" class="form-control" id="kh_email" name="kh_email" >
                        </div>
