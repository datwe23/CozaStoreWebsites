                      ...
                      <form method="post" action="{{ route('color.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          <div style="padding-top:10px"class="form-group col-6">
                            ...
                            <input type="text" class="form-control" id="m_ma" name="m_ma" >
                          </div>
                        <div style="padding-top:10px"class="form-group col-6">
                          <label for="m_ten">Color name</label>
                          <input type="text" class="form-control" id="m_ten" name="m_ten" >
                        </div>
                        <div class="form-group col-4">
                            <label for="m_trangThai">Color Status</label>
                            <select name="m_trangThai" class="form-control">
                                <option value="1" {{ old('m_trangThai') == 1 ? "selected" : "" }}>Locked</option>
                                <option value="2" {{ old('m_trangThai') == 2 ? "selected" : "" }}>Unlocked</option>
                            </select>
                            </div>
