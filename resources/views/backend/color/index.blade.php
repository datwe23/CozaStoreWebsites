            ...
            <div class="card mb-4">
                <div style="justify-content: space-between ; display:flex" class="card-header ">
                    ...
                    <div class="header-right">
                        <a href="{{ route('color.create') }}" class="btn btn-primary btn-sm mb-0 w-100" ><i style="padding-right:10px" class="fa fa-plus-square" aria-hidden="true"></i>Add new Color</a>
                    </div>
                </div>
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    <th style="text-align:center" class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">STT</th>
                                    <th style="text-align:center" class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Color ID</th>
                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Color Name</th>
                                  ...
                                  <td style="width:25px ; text-align:center">
                                    ...
                                    <td class="align-middle">
                                        <form action="{{ route('color.destroy',$m->m_ma) }}" method="POST">
                                            <a  href="{{ route('color.edit' , $m ->m_ma ) }}"class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">Edit  |</a>
                                            <a style="color: #f64468" href="{{ route('color.destroy' , $m ->m_ma ) }}" onclick="return confirm('Bạn có chắc muốn xóa?')" class="font-weight-bold text-xs">Delete</a>
                                            </form>
                                    </td>
                                </tr>
                                @endforeach
