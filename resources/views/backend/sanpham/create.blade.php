                    ...
                    <div class="table-responsive p-0">
                      <form method="post" action="{{ route('admin.sanpham.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-4">
                          ...
                          <input type="date" class="form-control" id="sp_taoMoi" name="sp_taoMoi" value="{{ old('sp_taoMoi') }}">
                        </div>
                        <div class="form-group col-4">
                          <label for="sp_capNhat">Ngày cập nhật</label>
                          <input type="date" class="form-control" id="sp_capNhat" name="sp_capNhat" value="{{ old('sp_capNhat') }}">
                        </div>
                        <div class="form-group col-4">
