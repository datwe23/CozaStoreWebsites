            ...
            <div class="row">
                <div class="col-12">
                    <div style="padding:30px" class="card mb-4">
                        <div style="padding-left:0px ; padding-top:0px ;border-bottom:1px solid rgb(94, 92, 92) "
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-4">
                                            ...
                                            <input type="text" class="form-control" id="sp_danhGia" name="sp_danhGia"
                                                value="{{ old('sp_danhGia') }}">
                                        </div>
                                        <div style=" padding-left:10px ; padding-top:20px" class="form-group col-12">
                                            <script class="jsbin"
                                                src="https://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js">
                                            </script>
                                            <div style="text-align: center;border:1px rgb(70, 20, 250) solid ;border-style: dashed "
                                                class="file-upload">
                                                <button class="btn btn-primary btn-sm mb-0 w-30" type="button"
                                                ...
                                                <div class="image-upload-wrap">
                                                    ...
                                                    <div class="all">
                                                        ...
                                                        <h3
                                                            style="font-family: Arial, Helvetica, sans-serif ; font-weight:200;padding-top:10px; font-size:20px ">
                                                ...
                                                <div class="file-upload-content">
                                                    ...
                                                    <div class="image-title-wrap">
                                                        <button style="background-color: #fb6b4b ; color:11px"
                                                            type="button" onclick="removeUpload()"
                                                            class="remove-image btn btn-primary btn-sm mb-0 w-30"><i
                                                                style="padding-right:5px" class="fa fa-minus-circle"
                                        ...
                                        <div class="form-group col-4">
                                            ...
                                            <input type="date" class="form-control" id="sp_capNhat" name="sp_capNhat"
                                                value="{{ old('sp_capNhat') }}">
                                        </div>
                                        <div class="form-group col-4">
                                            <label for="sp_trangThai">Trạng thái</label>
                                            <select name="sp_trangThai" class="form-control">
                                                <option value="1" {{ old('sp_trangThai') == 1 ? "selected" : "" }}>Khóa
                                                </option>
                                                <option value="2" {{ old('sp_trangThai') == 2 ? "selected" : "" }}>Khả
                                                    dụng</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <div class="file-loading">
                                                ...
                                                <input id="sp_hinhanhlienquan" type="file" name="sp_hinhanhlienquan[]"
                                                    multiple>
                                            </div>
                                        </div>
