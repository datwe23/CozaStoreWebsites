                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align:center" class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">employee ID</th>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">employee Account</th>
                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">employee Name</th>
                                    <th style="width:25px" class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Gender</th>
                                    <th style="width:25px" class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Email</th>
                                    <th style="width:25px" class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Phone Number</th>
                            ...
                            <tbody>
                              @foreach($nhanviens as $key => $nv)
                              <tr>
                                    <td style="width:25px">
                                      <h6 style="padding-left:20px" class="text-xs font-weight-bold mb-0">{{ $key+1 }}</h6>
                                  </td>
                                  <td style="width:25px ; text-align:center">
                                    <h6  class="text-xs font-weight-bold mb-0">{{ $nv->nv_ma }}</h6>
                                </td>
                                    <td>
                                        <div class="d-flex px-2 py-1">
                                            <div class="d-flex flex-column justify-content-center">
                                                <p class="text-xs text-secondary mb-0">{{ $nv->nv_taiKhoan }}</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td >
                                        <p class="text-xs font-weight-bold mb-0">{{ $nv->nv_hoTen }}</p>
                                    </td>
                                    ...
                                    <td style="width:25px" class="align-middle text-center">
                                      <p class="text-secondary text-xs font-weight-bold">{{ $nv->nv_email }}</p>
                                    </td>
                                    <td style="width:25px" class="align-middle text-center">
                                        <p class="text-secondary text-xs font-weight-bold">{{ $nv->nv_dienThoai }}</p>
                                      </td>
                                    ...
                                    <td class="align-middle">
                                        <form action="{{ route('nhanvien.destroy',$nv->nv_ma) }}" method="POST">
                                            <a  href="{{ route('nhanvien.edit' , $nv ->nv_ma ) }}"class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">Edit  |</a>
                                            <a  href="{{ route('nhanvien.show' , $nv ->nv_ma ) }}" class="text-secondary font-weight-bold text-xs"><i class="fa fa-television" aria-hidden="true"></i> |</a>
                                            <a style="color: #f64468" href="{{ route('nhanvien.destroy' , $nv ->nv_ma ) }}" onclick="return confirm('Bạn có chắc muốn xóa?')" class="font-weight-bold text-xs">Delete</a>
                                            </form>
                                    </td>
                                </tr>
                                @endforeach
