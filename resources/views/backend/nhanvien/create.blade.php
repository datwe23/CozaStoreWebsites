                      ...
                      <form method="post" action="{{ route('nhanvien.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          <div style="padding-top:10px"class="form-group col-6">
                            <label for="nv_hoTen">Employee ID</label>
                            <input type="text" class="form-control" id="nv_ma" name="nv_ma" >
                          </div>
                        <div style="padding-top:10px"class="form-group col-6">
                          <label for="nv_hoTen">name</label>
                          <input type="text" class="form-control" id="nv_hoTen" name="nv_hoTen" >
                        </div>
                        ...
                        <div class="form-group col-4">
                          ...
                          <input type="text" class="form-control" id="nv_email" name="nv_email" >
                        </div>

                        <div class="form-group col-4">
                            <label for="nv_dienThoai">Phone number</label>
                            <input type="text" class="form-control" id="nv_dienThoai" name="nv_dienThoai" >
                          </div>
